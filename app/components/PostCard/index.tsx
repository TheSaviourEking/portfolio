...
const PostCard = ({ post }: PostCardProps) => {
    const { title, link, pubDate, content, source, categories } = post;
    return (
        <div className="h-full flex">
            <a className='w-full flex flex-col justify-between bg-primary rounded-md p-4 border-b-2' href={`${link}`} target='_blank'>
