    ...
    return (
        <>
            <figure className="max-w-lg">
                <Image className="h-auto rounded-full sm:rounded-full lg:rounded-none max-w-full" src={'/profile-photo-square.jpeg'} alt="Saviour Eking with a big smile on his face 😊" width={1000} height={1000} />
